...
использовать и в действующих проектах, (в часности написанных на React) где есть потребность в ранжировании продукта, который 
предоставляет ваш сервис, по оценкам пользователей.
```
