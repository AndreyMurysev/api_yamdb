...
```
Данный проект создан с целью изучения фреймворка Django REST framework для разработки API., но при этом данное приложение возможно
использовать и в действующих проектах, (в часности написанных на React) где есть потребность в готовом приложении,
работающем на API, для ранжирования продукта по оценкам пользователей, который предоставляет ваш сервис,
```
